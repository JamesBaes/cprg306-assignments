...
export default function Page() {
  ...
  return (
    <main className="bg-indigo-800 p-5 min-h-screen">
      <h1 className="font-mono font-extrabold text-4xl text-center text-white">Week 10</h1>
      <div className="flex justify-center font-mono text-center text-xl text-white">
        {user ? (
          <div>
            ...
            <p>Click <Link className="hover:text-slate-300 hover:underline" href="/week-10/shopping-list">here</Link> to view the Shopping list.</p>
            <br/>
            <br/>
            <br/>
